...
export default async function AdminRunDetailPage({ params }: { params: Promise<{ runId: string }> }) {
  ...
  return <main className="admin-page">
    ...
    <section className="metric-row"><Metric label="Stage" value={run.stage} /><Metric label="Execution" value={run.executionNumber} /><Metric label="Model tokens" value={run.usage.inputTokens + run.usage.outputTokens} /><Metric label="Model time" value={`${Math.round(run.usage.durationMs / 1000)}s`} /></section>
