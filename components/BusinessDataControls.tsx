...
import type { BusinessStateV2, SiteIntentV2 } from "@/packages/site-contracts";

export function BusinessDataControls({ siteId, state, intent }: { siteId: string; state: BusinessStateV2; intent: SiteIntentV2 }) {
  ...
  return <div className="owner-authority-stack">
    {notice ? <div className="site-agent-notice" role="status">{notice}</div> : null}
    <section className="panel"><div className="section-heading-row"><div><h2>Contact</h2><p className="muted">Confirmed changes recompile the current design without a redesign.</p></div><span className="badge">Revision {state.revision}</span></div>
    ...
    <section className="panel"><div className="section-heading-row"><div><h2>Hours</h2><p className="muted">Published hours remain canonical business data across every page.</p></div><span className="badge">{state.locations.length}</span></div>
    ...
    <section className="panel"><div className="section-heading-row"><div><h2>Services</h2><p className="muted">Observed services can be confirmed, hidden, or assigned a dedicated page.</p></div><span className="badge">{state.offerings.length}</span></div>
    ...
    <section className="panel"><div className="section-heading-row"><div><h2>Verified links</h2><p className="muted">External destinations require operator review before entering a replacement version.</p></div><span className="badge">{state.links.length}</span></div>
