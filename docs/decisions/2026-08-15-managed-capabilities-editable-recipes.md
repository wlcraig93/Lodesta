...
> Superseded on 2026-08-20 for blank-workspace recipe materialization by `2026-08-20-canonical-authoring-isolation.md`. The trusted navigation and managed-form boundaries remain in force; the prior recipe treatment and evidence remain immutable historical context.
