...
import { evaluateCrawlAgainstStandard } from "@/lib/standard-evaluation";
  ...
  return {
    ...
    assessment: {
      ...
      publicPresenceNotes: [
        ...
        "Official/public presence signals are stored with provenance and confidence, then confirmed by the site owner before publication."
      ]
    },
    crawl,
    renderInspection,
