import type { CrawlAssessment, ExtractedBusinessFacts } from "@/lib/crawler";
import { normalizeObservedBusinessHours } from "@/lib/business-fact-normalization";
...
export function placeToPublicPresenceEnrichment(
  ...
  const signal: PublicPresenceSignal = {
    ...
    notes: [
      ...
      "Places facts remain unconfirmed owner truth until the site owner reviews them."
    ]
  };
