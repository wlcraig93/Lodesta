...
The offerings list contains positively established services, not an exhaustive exclusion list. Preserve those offerings and use the same business's first-party service headings and evidence to represent its ordinary service scope. Do not equate incomplete extraction with an exclusive service catalog. Do not override explicit owner restrictions, extend the geographic scope, infer unsupported services, or turn ordinary descriptions into credentials or promises.
