...
import type { ArtifactBlobStore, ImmutableBlob } from "../packages/site-artifacts/blob-store";
...
const prepared = prepareSiteArtifact({
  ...
  authoredArtifact: {
    ...
    claims: [],
    capabilityBindings: [{ id: "contact_form", kind: "form", route: "/contact", config: { formId: form.id } }]
  }
});
