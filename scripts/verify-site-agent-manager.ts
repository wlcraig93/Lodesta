...
for (const contract of [
  ...
  /Share the header, footer, tokens and primitives.*sibling pages of the same kind should look consistent/i,
  /best allowable photograph a large, well-cropped role in the first viewport/i,
