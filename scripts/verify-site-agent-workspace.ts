...
assert(component.includes("This makes this reviewed draft public.") && component.includes("This replaces your current live website with this reviewed draft."), "Publish confirmation does not distinguish first publication from replacement.");
